...
namespace InteractiveLSUMap.ViewModels
{
    public class MemoriesViewModel : BaseViewModel
    {
        ...
        {
            {"Prescott Hall", new[] {-91.1808370061389, 30.41350846773524}},
            {"Nicholson", new[] {-91.17865131560713, 30.41253870863463}},
            {"Coates Hall", new[] {-91.17906528057395, 30.413187536318254}},
            {"LSU Library", new[] {-91.18020361641825, 30.414403792577836}},
            {"Howe-Russell Geoscience Complex", new[] {-91.178737957784, 30.41176666593225}},
            {"Student Union", new[] {-91.1772527830808, 30.412686148493126}},
            {"Lockett Hall", new[] {-91.1818003245514, 30.413306022930918}},
            {"Art & Design Building", new[] {-91.17999043269066, 30.411197019821028}},
